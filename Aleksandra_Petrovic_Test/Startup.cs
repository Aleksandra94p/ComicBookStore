...
namespace Aleksandra_Petrovic_Test
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Aleksandra_Petrovic_Test", Version = "v1" });
            });
            ...
            services.AddAutoMapper(typeof(ComicBookProfile));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Aleksandra_Petrovic_Test v1"));
            }
